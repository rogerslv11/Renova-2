...
export const differentiatorsData: Differentiator[] = [
  ...
  },
  {
    ...
    description: 'Foco dedicado na impermeabilização em fibra de vidro, aplicação de rejuntamento epóxi, acrílico e cimentício, além de diagnóstico de infiltrações para máxima durabilidade.',
    iconName: 'Users'
  },
  {
    id: 4,
  ...
  },
  {
    ...
    description: 'Nossa equipe é 100% própria, técnica e qualificada. Trabalhamos com profissionais focados na excelência e comprometidos com o prazo de entrega da sua obra.',
    iconName: 'Wrench'
  },
  {
    id: 6,
